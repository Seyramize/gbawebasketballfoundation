  ...
  return (
    <div className="container px-4 md:px-6 py-12 md:py-24">
      <div className="max-w-3xl mx-auto space-y-12">
        ...
        <section className="space-y-6">
          <h2 className="text-2xl font-bold">Our Approach: Own Your Dreams</h2>
          <p className="text-lg text-gray-700">We serve communities by:</p>
          <ul className="ml-6 space-y-2 list-disc text-gray-700">
            <li>Sponsoring talented youth through scholarships</li>
            <li>Hosting free training camps and school clinics</li>
            <li>Promoting cultural pride and leadership</li>
